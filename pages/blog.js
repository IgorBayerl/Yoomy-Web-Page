        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-4 -mb-4">
            ...
            <div className="w-full lg:w-1/2 px-4 mb-12">
              <div className="flex h-96 mb-6"><img className="w-full h-full object-cover rounded-lg" src="https://static.shuffle.dev/uploads/files/fb/fbaf56534de36adf7161c70c61794f293b314223/young-pretty-woman-eating-pizza-at-pizza-bar.jpg" alt /></div>
              <a className="text-white font-bold bg-yellow-400 leading-loose rounded px-3 py-3">Vida e Hobbie</a>
              <h2 className="mb-2 mt-2 text-3xl font-bold font-heading">A vida é melhor com amigos e familiares</h2>
              <p className="mb-4 text-lg text-gray-500">As pessoas que usam a yoomy encontram uma felicidade incrível, conseguem encontrar os restaurantes que melhor...</p>
              <a className="inline-block mb-3 lg:mb-0 w-full lg:w-auto py-2 leading-loose text-gray-400 font-semibold rounded-xl rounded-t-xl">Julia Almeida 27/03/2021</a>
            </div>
            <div className="hidden lg:inline-flex ml-2 flex flex-wrap -mx-4 lg:w-1/2">
              <div className="lg:w-1/2 px-4 mb-4 lg:mb-0"><img className="rounded shadow" src="https://static.shuffle.dev/uploads/files/ec/ec77466babe5e8f02d259b4c1654b23e4297f309/cheerful-friends-sitting-cafe-talking-with-each-other.jpg" alt /></div>
              <div className="lg:w-1/2 px-4">
                ...
                <a className="mt-6 inline-block mb-3 lg:mb-0  w-full lg:w-auto py-2 leading-loose text-gray-400 font-semibold rounded-xl rounded-t-xl">Julia Almeida 27/03/2021</a>
              </div>
              <div className="lg:w-1/2 px-4 mb-4 lg:mb-0"><img className="rounded shadow" src="https://static.shuffle.dev/uploads/files/ec/ec77466babe5e8f02d259b4c1654b23e4297f309/cheerful-friends-sitting-cafe-talking-with-each-other.jpg" alt /></div>
              <div className="lg:w-1/2 px-4">
                <a className="text-white font-bold bg-yellow-400 leading-loose rounded px-2 py-2">Vida e Hobbie</a>
            ...
            <div className="lg:hidden w-full lg:w-1/2 px-4 mb-12">
              <div className="flex h-96 mb-6"><img className="w-full h-full object-cover rounded-lg" src="https://static.shuffle.dev/uploads/files/fb/fbaf56534de36adf7161c70c61794f293b314223/young-pretty-woman-eating-pizza-at-pizza-bar.jpg" alt /></div>
              <a className="text-white font-bold bg-yellow-400 leading-loose rounded px-3 py-3">Vida e Hobbie</a>
              <h2 className="mb-2 mt-2 text-3xl font-bold font-heading">A vida é melhor com amigos e familiares</h2>
              <p className="mb-4 text-lg text-gray-500">As pessoas que usam a yoomy encontram uma felicidade incrível, conseguem encontrar os restaurantes que melhor...</p>
      ...
      <section>
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-4 mb-4">
            ...
            <div className="lg:hidden w-full lg:w-1/2 px-4 py-3 mb-12 mx-4 border rounded">
              <div className="pt-2 block">
                <div className="w-40 bg-yellow-400 rounded">
